...
export const DEFAULT_PR_CREATE_NUDGE =
	"🔔 PR {prLabel} was just created. Consider starting PR monitoring with ghpr-monitor(action='start', url='{prUrl}') to track review comments, merge conflicts, and CI status.";
